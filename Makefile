...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Salt CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Salt controllers
...
# This target prepares repo for your provider by replacing all "salt"
